...
1. **Download the Extension**
   ```bash
   git clone https://github.com/yourusername/ai-guided-contribution.git
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/ai-guided-contribution/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/ai-guided-contribution/discussions)
